...
<body>
   ...
   <header>
        <nav>
            ...
            <ul class="nav-links">
              <li class="btn btn-light"><a href="<?=base_url('public/home')?>">Home</a></li>
              ...
              <li class="btn btn-info"><a href="<?=base_url('public/home/signup')?>">Sign Up</a></li>
              <li><a href="<?=base_url('public/home/login')?>" class="btn btn-primary">Login</a></li>
            </ul>
            <!-- menu bar -->
          <div class="menu-bar">
            ...
            <div id="hidden" class="menu-items" style="display: none;">
              <ul>
                ...
                <li ><a href="<?=base_url('public/home/signup')?>">Sign Up</a></li>
                <li><a href="<?=base_url('public/home/login')?>" >Login</a></li>
              </ul>
    ...
    <footer>
        <div class="footer-container">
          ...
          <div class="footer-section">
            ...
            <a href="<?=base_url('public/home/career')?>">Careers</a>
          </div>
          <div class="footer-section">
            <h3>Privacy Policy</h3>
            <a href="<?=base_url('public/home/privacypolicy')?>">Privacy Policy</a>
          </div>
        </div>
