<?= $this->extend('layouts/masterAdmin') ?>
    ...
    <form action="<?=base_url('public/admin/looktype/create')?>" method="post">
            ...
            <input type="hidden" name="looktypeid" value="<?= isset($item) ? $item->look_type_id : '' ?>"/>
            <fieldset>
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="looktypename" id="looktypename" placeholder="look type name" class="form-control" value="<?= isset($item) ? $item->look_type_name : '' ?>" />
              </div>
