      ...
      <?php endif;?>
            ...
            <fieldset>
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="company_name" id="company_name" placeholder="company name" class="form-control" value="<?= isset($item) ? $item->name : '' ?>" />
              </div>
              <div class="form-group">
                  <label for="company_vision"><i class="zmdi zmdi-account material-icons-name"></i>Company Vision: </label>
                  <textarea name="company_vision" cols="30" rows="3" class="form-control" value="" ></textarea>
                  <!-- <input type="text" name="company_vision" id="company_vision" placeholder="company vision" class="form-control" value="<?= isset($item) ? $item->phone : '' ?>" /> -->
              </div>
              <div class="form-group">
                  <label for="company_address"><i class="zmdi zmdi-account material-icons-name"></i>Company Address: </label>
                  <input type="text" name="company_address" id="company_address" placeholder="company address" class="form-control" value="<?= isset($item) ? $item->email : '' ?>" />
              </div>
              <div class="form-group">
                  ...
                  <input type="text" name="company_email" id="company_email" placeholder="company email" class="form-control" value="" />
              </div>
